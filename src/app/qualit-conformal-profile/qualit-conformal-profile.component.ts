...
@Component({
  selector: 'app-qualit-conformal-profile',
  templateUrl: './qualit-conformal-profile.component.html',
  styleUrls: ['./qualit-conformal-profile.component.css']
})
export class QualitConformalProfileComponent implements OnChanges {
