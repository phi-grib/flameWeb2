...
@Component({
  selector: 'app-quantit-conformal-profile',
  templateUrl: './quantit-conformal-profile.component.html',
  styleUrls: ['./quantit-conformal-profile.component.css']
})
export class QuantitConformalProfileComponent implements OnChanges {
