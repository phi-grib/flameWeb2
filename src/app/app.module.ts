...
import { InputFileComponent } from './select-compound/options/input-file/input-file.component';
import { SketchStructureComponent } from './select-compound/options/sketch-structure/sketch-structure.component';
import { InputListComponent } from './select-compound/options/input-list/input-list.component';
