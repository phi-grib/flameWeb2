...
@Component({
  selector: 'app-prediction-multiple',
  templateUrl: './prediction-multiple.component.html',
  styleUrls: ['./prediction-multiple.component.css']
})
export class PredictionMultipleComponent implements OnInit {
